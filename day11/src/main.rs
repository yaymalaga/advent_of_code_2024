...
impl From<StonesList> for String {
    fn from(value: StonesList) -> Self {
        value
            .0
            .iter()
            .map(|number| number.id.to_string())
            .collect::<Vec<String>>()
            .join(" ")
    }
}
...
mod tests {
    ...
    fn check_blink_n() {
        ...
        // let test_data_string: String = test_data.into();

        // assert_eq!(
        //     test_data_string,
        //     String::from("2097446912 14168 4048 2 0 2 4 40 48 2024 40 48 80 96 2 8 6 7 6 0 3 2")
        // );
    }
